<template>
  <div>
    ...
    <div class="breadCrumbNav clearfix" style="width: 1190px;">
      ...
      <router-link tag="span" :to="{ name: 'service' }">
        <a href="">云服务</a>
      </router-link>
    </div>
    <div class="wrapper">
      ...
      <div class="right">
        <div class="result-top">
          <div class="sort">
            ...
            <a href="javascript:;" :class="{'active': params.orderBy === 3}" @click="handleSort(3)">关注量</a>
            <a href="javascript:;" :class="{'active': params.orderBy === 4}" @click="handleSort(4)">申请量</a>
          </div>
        ...
        <ServiceItem v-for="item in dataList" :item="item" :key="item.id"></ServiceItem>
